...
st.sidebar.markdown("## Marcelle Christelle NGOG HOPP")
...
if page == pages[1] :
    ...
    st.markdown("<div style='text-align: justify;'>Ces valeurs manquantes sont en fait des absences d'actions dans chaques catégories. Nous décidons alors de les remplacer par des zéros.</div>", unsafe_allow_html=True)
...
equipe_442 = mercato(all_players, "Ligue 1", 500, "4-4-2", LogisticRegression(random_state = 27))[0]
equipe_433 = mercato(all_players, "Ligue 1", 500, "4-3-3", LogisticRegression(random_state = 27))[0]
equipe_4123 = mercato(all_players, "Ligue 1", 500, "4-1-2-3", LogisticRegression(random_state = 27))[0]
equipe_4213 = mercato(all_players, "Ligue 1", 500, "4-2-1-3", LogisticRegression(random_state = 27))[0]
equipe_352 = mercato(all_players, "Ligue 1", 500, "3-5-2", LogisticRegression(random_state = 27))[0]
equipe_532 = mercato(all_players, "Ligue 1", 500, "5-3-2", LogisticRegression(random_state = 27))[0]
...
if page == pages[8] : 
  ...
  st.markdown("*Nous utiliserons ici les effectifs récupérées pour la Ligue 1 selon les tactiques proposées par le mercato*.")
  col1, col2 = st.columns(2)
  choix1 = ["Équipe 442", "Équipe 433", "Équipe 4123", "Équipe 4213", "Équipe 352", "Équipe 532"]
  choix2 = ["4-4-2", "4-3-3", "4-1-2-3", "4-2-1-3", "3-5-2", "5-3-2"]
  with col1:
      option1 = st.selectbox('Effectif', choix1)
  with col2:
      option2 = st.selectbox('Tactique', choix2)
      
  if (option1 == "Équipe 442") & (option2 == "4-4-2"):
      compo = composition(equipe_442, "4-4-2")
  elif (option1 == "Équipe 442") & (option2 == "4-3-3"): 
      compo = composition(equipe_442, "4-3-3")
  elif (option1 == "Équipe 442") & (option2 == "4-1-2-3"): 
      compo = composition(equipe_442, "4-1-2-3")
  elif (option1 == "Équipe 442") & (option2 == "4-2-1-3"): 
      compo = composition(equipe_442, "4-2-1-3")
  elif (option1 == "Équipe 442") & (option2 == "3-5-2"): 
      compo = composition(equipe_442, "3-5-2")
  elif (option1 == "Équipe 442") & (option2 == "5-3-2"): 
      compo = composition(equipe_442, "5-3-2")

  if (option1 == "Équipe 433") & (option2 == "4-4-2"):
      compo = composition(equipe_433, "4-4-2")
  elif (option1 == "Équipe 433") & (option2 == "4-3-3"): 
      compo = composition(equipe_433, "4-3-3")
  elif (option1 == "Équipe 433") & (option2 == "4-1-2-3"): 
      compo = composition(equipe_433, "4-1-2-3")
  elif (option1 == "Équipe 433") & (option2 == "4-2-1-3"): 
      compo = composition(equipe_433, "4-2-1-3")
  elif (option1 == "Équipe 433") & (option2 == "3-5-2"): 
      compo = composition(equipe_433, "3-5-2")
  elif (option1 == "Équipe 433") & (option2 == "5-3-2"): 
      compo = composition(equipe_433, "5-3-2")    
      
  if (option1 == "Équipe 4123") & (option2 == "4-4-2"):
      compo = composition(equipe_4123, "4-4-2")
  elif (option1 == "Équipe 4123") & (option2 == "4-3-3"): 
      compo = composition(equipe_4123, "4-3-3")
  elif (option1 == "Équipe 4123") & (option2 == "4-1-2-3"): 
      compo = composition(equipe_4123, "4-1-2-3")
  elif (option1 == "Équipe 4123") & (option2 == "4-2-1-3"): 
      compo = composition(equipe_4123, "4-2-1-3")
  elif (option1 == "Équipe 4123") & (option2 == "3-5-2"): 
      compo = composition(equipe_4123, "3-5-2")
  elif (option1 == "Équipe 4123") & (option2 == "5-3-2"): 
      compo = composition(equipe_4123, "5-3-2")
      
  if (option1 == "Équipe 4213") & (option2 == "4-4-2"):
      compo = composition(equipe_4213, "4-4-2")
  elif (option1 == "Équipe 4213") & (option2 == "4-3-3"): 
      compo = composition(equipe_4213, "4-3-3")
  elif (option1 == "Équipe 4213") & (option2 == "4-1-2-3"): 
      compo = composition(equipe_4213, "4-1-2-3")
  elif (option1 == "Équipe 4213") & (option2 == "4-2-1-3"): 
      compo = composition(equipe_4213, "4-2-1-3")
  elif (option1 == "Équipe 4213") & (option2 == "3-5-2"): 
      compo = composition(equipe_4213, "3-5-2")
  elif (option1 == "Équipe 4213") & (option2 == "5-3-2"): 
      compo = composition(equipe_4213, "5-3-2")

  if (option1 == "Équipe 352") & (option2 == "4-4-2"):
      compo = composition(equipe_352, "4-4-2")
  elif (option1 == "Équipe 352") & (option2 == "4-3-3"): 
      compo = composition(equipe_352, "4-3-3")
  elif (option1 == "Équipe 352") & (option2 == "4-1-2-3"): 
      compo = composition(equipe_352, "4-1-2-3")
  elif (option1 == "Équipe 352") & (option2 == "4-2-1-3"): 
      compo = composition(equipe_352, "4-2-1-3")
  elif (option1 == "Équipe 352") & (option2 == "3-5-2"): 
      compo = composition(equipe_352, "3-5-2")
  elif (option1 == "Équipe 352") & (option2 == "5-3-2"): 
      compo = composition(equipe_352, "5-3-2")

  if (option1 == "Équipe 532") & (option2 == "4-4-2"):
      compo = composition(equipe_532, "4-4-2")
  elif (option1 == "Équipe 532") & (option2 == "4-3-3"): 
      compo = composition(equipe_532, "4-3-3")
  elif (option1 == "Équipe 532") & (option2 == "4-1-2-3"): 
      compo = composition(equipe_532, "4-1-2-3")
  elif (option1 == "Équipe 532") & (option2 == "4-2-1-3"): 
      compo = composition(equipe_532, "4-2-1-3")
  elif (option1 == "Équipe 532") & (option2 == "3-5-2"): 
      compo = composition(equipe_532, "3-5-2")
  elif (option1 == "Équipe 532") & (option2 == "5-3-2"): 
      compo = composition(equipe_532, "5-3-2")         
